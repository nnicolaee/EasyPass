...
import 'ticket_payment_model.dart';
export 'ticket_payment_model.dart';

class TicketPaymentWidget extends StatefulWidget {
  const TicketPaymentWidget({super.key});

  @override
  State<TicketPaymentWidget> createState() => _TicketPaymentWidgetState();
}

class _TicketPaymentWidgetState extends State<TicketPaymentWidget> {
  late TicketPaymentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TicketPaymentModel());
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Image.network(
                                      'https://www.pngmart.com/files/22/Mastercard-Logo-PNG-Picture.png',
                                      width: 40.0,
                                      height: 25.0,
                                      fit: BoxFit.contain,
                                    ),
