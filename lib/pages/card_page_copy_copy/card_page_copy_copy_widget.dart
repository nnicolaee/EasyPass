...
import 'card_page_copy_copy_model.dart';
export 'card_page_copy_copy_model.dart';

class CardPageCopyCopyWidget extends StatefulWidget {
  const CardPageCopyCopyWidget({super.key});

  @override
  State<CardPageCopyCopyWidget> createState() => _CardPageCopyCopyWidgetState();
}

class _CardPageCopyCopyWidgetState extends State<CardPageCopyCopyWidget> {
  late CardPageCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardPageCopyCopyModel());
  }
